package cl.bancofalabella.icetest.utils;
...
public class FacesUtils implements Serializable {
    ...
    public static Object getBean(String beanName) {
        ...
        try {
            ...
            LOGGER.debug("Error al obtener Bean: {}", ex.toString(), ex);
        }
    ...
    public static String getRequestParameter(String key) {
        return StringUtils.trimToEmpty(((HttpServletRequest) getExternalContext().getRequest()).getParameter(key));
    }
    ...
    public static void setSessionValue(String key, Serializable value) {
